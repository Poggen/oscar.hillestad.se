    ...
    render = { data => (
        <section className={styles.greeting}>
          ...
          <div className={styles.greetingContainer}>
            ...
            <span className={styles.greetingLead}>I'm Oscar, a passionate team leader who loves creating digital products. Currently Technical Partner Manager at <a href="https://wirelesscar.com">WirelessCar</a>.</span>
          </div>
        </section>
      )
    }
